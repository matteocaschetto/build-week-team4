...
import { BiInfoSquare, BiChevronDown, BiChevronRight , BiCopyright, BiLogoLinkedinSquare} from "react-icons/bi";
        ...
        <Col className="col-12 mt-4">
          ...
          <div className="w-100 bg-transparent text-center mt-3">
             <Row className="d-flex align-items-center justify-content-end pe-3">
                ...
                <Col style={{margin:"2px 0"}} className="px-0 col-9 d-flex justify-content-end pe-3"><a className="text-secondary" style={{textDecoration:"none", fontSize:"0.7rem"}} href="">Scarica l app LinkedIn</a></Col>
                <Col style={{margin:"2px 0"}} className="px-0 col-3 d-flex justify-content-start"><a className="text-secondary" style={{textDecoration:"none", fontSize:"0.7rem"}} href="">Altro</a></Col>
