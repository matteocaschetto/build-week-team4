  ...
  return (
      ...
      <div className="rounded-4 bg-white mt-2 p-3">
        <div className="d-flex align-items-start">
          ...
          <div className="d-flex flex-column">
            ...
            <div className="d-flex align-items-center">
               <p className="text-secondary fs-6 my-0">1 Giorno, <span className="text-secondary"></span> Modificato <span className="text-secondary"></span></p><BiWorld className="ms-2 fs-4"/>
            </div>
          </div>
        </div>
        <div>
    ...
    <div className="rounded-4 bg-white mt-2">
     <div className="d-flex mt-2 p-3">
      ...
      <div className="">
        <img src="https://cinemaserietv.it/wp-content/uploads/2022/08/netflix-ultime-uscite.jpg" width={"100%"} height={"250"} className="me-2" alt="boh" />
      <hr />
      <div className="d-flex justify-content-around mb-3">
        <div className="d-flex align-items-center">
          <BiLike className="fs-4"></BiLike>
