    ...
    <Container className="d-flex flex-column">
      ...
      <div className="rounded-4 bg-white mt-2">
        <div className="d-flex mt-2 p-3">
          ...
          <div className="d-flex flex-column lh-1">
            <p className="text-secondary fs-6 my-0 pb-2">
              <span className="text-black fs-5 fw-bold">Lexus Italia</span>
            </p>
            <p className="text-secondary fs-6 my-0">
              Da oggi avere la tua nuova Lexus non è mai stato così facile e sicuro, comodamente da casa tua: fissa il primo appuntamento in videochiamata
            </p>
          </div>
        </div>
      ...
      <div className="rounded-4 bg-white mt-2">
        <div className="d-flex mt-2 p-3">
          ...
          <div className="d-flex flex-column lh-1">
            <p className="text-secondary fs-6 my-0 pb-2">
              <span className="text-black fs-5 fw-bold">Netflix Italia</span>
            </p>
            <p className="text-secondary fs-6 my-0">
        ...
        <div className="">
          <img
            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRIS6ArMoMcbj-RiMp6fOBcEMatQQMkhBouqg&s"
            width={"100%"}
            height={"400"}
            className="me-2"
            alt="boh"
