  ...
  return (
    <Container className="d-flex flex-column">
      <div className="rounded-4 bg-white mt-2 position-relative">
        ...
        />
        <img
          src={profile.image || "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQqxKQClJxfLRjnXNxZi2-6EwQlOgdOj_Sj1A&s"} // Use profile image or fallback image
          alt="Profile"
          width={100}
          height={100}
      ...
      <div className="p-3 rounded-4 bg-white mt-2">
        <p className="text-secondary mb-1 fw-semi-bold fs-6">Accedi a strumenti e informazioni in esclusiva</p>
