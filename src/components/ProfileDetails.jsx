...
const ProfileDetails = () => {
  ...
  useEffect(() => {
    ...
    const fetchProfile = async () => {
      try {
        const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2NzYwNWU4NDc0YTg2ODAwMTVkYjU0ZjkiLCJpYXQiOjE3MzQzNjg5MDAsImV4cCI6MTczNTU3ODUwMH0.qlKB2g8pPEkFuSrRMQ84ltLLbqQEaT46Vch8Hu9AHiE"; // Assicurati di inserire il token corretto
  ...
  return (
    <Container className="d-flex flex-column">
      <div className="rounded-4 bg-white mt-4">
        ...
        <h3 className="ps-4 m-0">{profile.name} {profile.surname}</h3>
      ...
      <div className="rounded-4 bg-white mt-2 p-3">
        ...
        <Button className="border-primary rounded-pill text-primary bg-white px-3" size="sm">Crea un post</Button>
        <p>
          <IoPencil />
        </p>
        </div>
        ...
        <div>
          ...
          <Button className="border-secondary rounded-pill text-secondary bg-white px-3" size="sm">Post</Button>
          <Button className="border-secondary rounded-pill text-secondary bg-white px-3" size="sm">Documenti</Button>
          </span>
        </div>
        <div className="d-flex align-items-center gap-2 mt-2">
          <img src="https://images-ext-1.discordapp.net/external/u9_nLQbZ6ALxXIBDBB0QLVMqM7vko1sMCFid-sWX1Qc/https/www.timevision.it/news/wp-content/uploads/2023/04/esperienze-lavorative.jpg?format=webp&width=1191&height=100" alt="work-experience" />
          <div>
      ...
      <div className="rounded-4 bg-white mt-2 p-3">
        ...
        <div>
          <span>
            Architetto con esperienza nella progettazione e realizzazione di
            spazi innovativi e sostenibili. Mi occupo di progettazione
            architettonica, pianificazione urbana e restauro, con un forte focus
            sulla funzionalità, l'estetica e l'efficienza energetica. Ho una
            solida esperienza nella gestione di progetti complessi, dalla fase
            di concept fino alla realizzazione, collaborando con team
            multidisciplinari per garantire il rispetto delle normative e delle
            tempistiche.
          </span>
        </div>
      </div>
