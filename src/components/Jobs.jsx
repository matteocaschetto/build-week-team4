...
import AsideLeftJobs from "./AsideLeftJobs";
        ...
        <Row className="d-flex justify-content-center">
          ...
          <Col className="col-12 col-md-8 col-lg-5">
            <div className="rounded-4 p-3 bg-white mt-2">
              <div>
                <p className="h1 fs-5 mb-2">
                  Le principali offerte di lavoro per te
                </p>
                <p className="h2 fs-6 text-secondary mb-4">
              ...
              <div className="d-flex justift-content-center">
                <Button className="bg-transparent text-black w-100 fw-bold align-content-center btn-outline-light">
                  Mostra tutto{" "}
                  <BiArrowToRight className="fs-3"></BiArrowToRight>
                </Button>
              </div>
            </div>
            <div className="rounded-4 p-3 bg-white mt-2">
              <div className="d-flex justify-content-between align-items-center">
                <p className="h3, mb-0 fs-5 fw-bold">
                  Lasciati trovare dalle offert di lavoro
                </p>
                <BiXCircle className="fs-4"></BiXCircle>
              </div>
              <div className="d-flex flex-column">
                <p className="fs-6 text-secondary">
                  Ricevi segnalazioni più rilevanti tenendo aggiornate le tue
                  preferenze Disponibile a lavorare.
                </p>
                <div className="d-flex">
                  <div className="me-2">
                    <img
                      src="https://cdn.pixabay.com/photo/2024/10/20/08/29/portrait-9134409_1280.png"
                      width={70}
                      height={70}
                      alt=""
                  ...
                  <div className="d-flex flex-column">
                    <p className="fw-semibold mb-0">
                      Dsiponibile per trovare lavoro
                    </p>
                    <p className="text-secondary mb-0">
                      Ultima attività in app: 3 mesi fa
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="rounded-4 p-4 bg-white mt-2">
              ...
              <div className="d-flex flex-wrap mt-3">
                <Button
                  onClick={() => {}}
                  className="bg-white btn-outline-primary px-3 fw-semibold rounded-pill me-2 mb-3  text-primary"
                >
                  <BiSearch className="fw-bolder fs-4 pe-1"></BiSearch>Data
                </Button>
                <Button
                  onClick={() => {}}
                  className="bg-white btn-outline-primary px-3 fw-semibold rounded-pill me-2 mb-3  text-primary"
                >
                  <BiSearch className="fw-bolder fs-4 pe-1"></BiSearch>Finance /
                  Legal
                </Button>
                <Button
                  onClick={() => {}}
                  className="bg-white btn-outline-primary px-3 fw-semibold rounded-pill me-2 mb-3  text-primary"
                >
                  <BiSearch className="fw-bolder fs-4 pe-1"></BiSearch>Marketing
                </Button>
                <Button
                  onClick={() => {}}
                  className="bg-white btn-outline-primary px-3 fw-semibold rounded-pill me-2 mb-3  text-primary"
                >
                  <BiSearch className="fw-bolder fs-4 pe-1"></BiSearch>Customer
                  Service
                </Button>
                <Button
                  onClick={() => {}}
                  className="bg-white btn-outline-primary px-3 fw-semibold rounded-pill me-2 mb-3  text-primary"
                >
                  <BiSearch className="fw-bolder fs-4 pe-1"></BiSearch>Human
                  Resources
                </Button>
                <Button
                  onClick={() => {}}
                  className="bg-white btn-outline-primary px-3 fw-semibold rounded-pill me-2 mb-3  text-primary"
                >
                  <BiSearch className="fw-bolder fs-4 pe-1"></BiSearch>Software
                  Development
                </Button>
                <Button
                  onClick={() => {}}
                  className="bg-white btn-outline-primary px-3 fw-semibold rounded-pill me-2 mb-3  text-primary"
                >
                  <BiSearch className="fw-bolder fs-4 pe-1"></BiSearch>Writing
                </Button>
              </div>
            </div>
            <div className="rounded-4 p-4 bg-white mt-2">
              <div className="d-flex">
                <img
                  ...
                  style={{ objectFit: "cover" }}
                />
                <p className="fs-5 ps-4 fw-semibold">
                  Vedi elenco completo delle offerte di lavoro per cui saresti
              ...
              <div>
                <div className="d-flex align-items-center">
                  <div className="d-flex ms-5 position-relative">
                    ...
                    />
                    <img
                      src="https://cdn.pixabay.com/photo/2020/11/06/03/43/protective-suit-5716753_1280.jpg"
                      width={30}
                      height={30}
                      className="rounded-circle"
                      alt=""
                  ...
                  <div>
                    <p className="text-secondary mb-0 ps-2">
              ...
              <div>
                <Button
                  className="px-5 text-dark fs-4 ms-5 fw-semibold rounded-pill mt-4"
                      ...
                      <div key={i} className="d-flex justify-content-between">
                        <div className="d-flex">
                          ...
                          <div>
                            ...
                            <p className="mb-0 text-secondary">
                              {job2.candidate_required_location}
                            </p>
                          </div>
                        </div>
                        <div>
          ...
          <Col className="d-none d-lg-block col-lg-3">
            <div className="w-100 bg-transparent text-center mt-3">
              <Row className="d-flex align-items-center justify-content-end pe-3">
                ...
                <Col
                  style={{ margin: "2px 0" }}
                  className="px-0 col-8 d-flex justify-content-end pe-3"
                >
                  <a
                    className="text-secondary"
                    style={{ textDecoration: "none", fontSize: "0.7rem" }}
                ...
                <Col
                  style={{ margin: "2px 0" }}
                  className="px-0 col-4 d-flex justify-content-start"
                >
                  <a
                    className="text-secondary"
                    style={{ textDecoration: "none", fontSize: "0.7rem" }}
